import { O as E, Q as mt, a as he, c as dt } from "./browser/chunk-NK5KMFGN.js";
var _ = (function (n) {
    return (
      (n[(n.State = 0)] = "State"),
    ...
    visitAnimate(e, t) {
      ...
      if (r.type == _.Keyframes) i = this.visitKeyframes(r, t);
        ...
        if (!o) {
          a = !0;
          let h = {};
          s.easing && (h.easing = s.easing), (o = De(h));
        }
  ...
  Te = class {
    ...
    build(e, t, s, i, r, o, a, l, h, c) {
      ...
      return (
        ...
        u.length
          ? Pt(t, this._triggerName, s, i, N, d, T, [], [], P, M, C, u)
          : (q.forEach((k) => {
              let W = k.element,
                J = O(P, W, new Set());
        ...
        this._namespaceList[f].drainQueuedTransitions(t).forEach((p) => {
          ...
          w.timelines.forEach((D) => {
            (D.stretchStartingKeyframe = !0),
              this.disabledNodes.has(D.element) || ft.push(D);
          }),
            (w.timelines = ft),
            s.append(A, w.timelines);
          let jt = { instruction: w, player: v, element: A };
          o.push(jt),
            w.queriedElements.forEach((D) => O(a, D, []).push(v)),
            w.preStyleProps.forEach((D, H) => {
              if (D.size) {
                let L = l.get(H);
                L || l.set(H, (L = new Set())),
                  D.forEach((le, Ne) => L.add(Ne));
              }
            }),
            w.postStyleProps.forEach((D, H) => {
              let L = h.get(H);
              L || h.set(H, (L = new Set())), D.forEach((le, Ne) => L.add(Ne));
            });
        });
      if (q.length) {
        let f = [];
      ...
      let a = t.triggerName,
        ...
        S = t.timelines.map((d) => {
          ...
          let b = g !== l,
            ...
            M = r.get(g),
            N = o.get(g),
            Z = Ot(this._normalizer, d.keyframes, M, N),
...
function Ai(n, e, t) {
  return n === "noop"
    ? new we(e, new Kt(), new Ie(), t)
    : new we(e, new Ze(), new Be(), t);
}
var Ft = class {
    constructor(e, t) {
      this._driver = e;
